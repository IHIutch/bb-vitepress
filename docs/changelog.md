...
::: tip
Use the [`_lastUpdated` parameter](./guides/going-to-production.md#use-_lastupdated-for-incremental-sync) to detect data changes in your application without polling for full datasets.
:::
