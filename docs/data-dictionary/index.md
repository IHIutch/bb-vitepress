...
Use the [`_lastUpdated` parameter](../guides/going-to-production.md#use-_lastupdated-for-incremental-sync) to fetch only records that changed since your last sync.
