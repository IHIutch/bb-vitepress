---
title: "Temporary service limitation during annual end-of-year transition"
...
- You will only be able to request runout data from BCDA from PY 2024. Use the `runout` identifier with the `/Group` endpoint to return data for enrollees attributed to your organization in PY 2024. 
  ...
  - You can use the [_since parameter](/guide/filtering#the-_since-parameter) with the runout identifier to limit data to updates occurring since your last runout request.
