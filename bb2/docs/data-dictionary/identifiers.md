...
A patient may have multiple MBIs (current and historic). Use the `identifier-currency` extension to determine which is current. See [Working with identifiers](../guide/fetching-patient-data.md#work-with-identifiers) for details and code examples.
