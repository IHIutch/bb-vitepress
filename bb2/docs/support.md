...
The user may have denied access to their demographics during authorization. Your app needs to handle this case. See [Scopes](./guide/authentication-and-oauth.md#scopes).

**Why is my refresh token not working?**
Refresh tokens are single-use. Each token exchange gives you a new refresh token. If you used it already, the user needs to re-authorize. See [Common errors](./guide/authentication-and-oauth.md#common-errors).
