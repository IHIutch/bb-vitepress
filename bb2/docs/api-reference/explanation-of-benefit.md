...
::: warning
EOB responses are large and paginated. A single patient can have hundreds of claims. See [Handling Pagination](../guide/handling-pagination.md).
:::
...
For a detailed walkthrough of item structure, adjudication, and claim types, see [Working with Claims](../guide/working-with-claims.md).
...
- **200 OK** — Success
- **400 Bad Request** — Invalid parameters (e.g., bad claim type value)
- **401 Unauthorized** — Invalid or expired access token
- **404 Not Found** — EOB not found
