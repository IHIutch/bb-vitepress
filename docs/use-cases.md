...
**How you'd build it:**
- Implement [OAuth consent flow](./guides/building-a-consent-flow.md) with clear explanation of research purposes
...
Start with the [Quickstart](./quickstart.md) to get your first API response in 5 minutes.
