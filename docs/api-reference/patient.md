...
The `identifier` array may contain multiple entries — typically a current MBI and historic MBIs. See [Working with identifiers](../guides/fetching-patient-data.md#work-with-identifiers) for how to find the current MBI.
...
| 403 | User denied access to demographics |
