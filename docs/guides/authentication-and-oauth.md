...
| Callback URLs / Redirect URIs | Your callback URL (space-separated for multiple) |
| Collect enrollee demographic data? | Yes (to access Patient and UserInfo resources) |
