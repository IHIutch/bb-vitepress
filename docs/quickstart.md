...
::: tip
The test client gives you a quick token for trying the API. For real apps, you'll implement the full OAuth flow — see the [Authentication guide](./guides/authentication-and-oauth.md).
:::
...
::: warning
ExplanationOfBenefit responses can be large — a single patient may have hundreds of claims. The response is paginated. See [Handling Pagination](./guides/handling-pagination.md) for how to work through all pages.
:::

## What's next

- [Authentication & OAuth](./guides/authentication-and-oauth.md) — implement the full OAuth flow in your app
- [Fetching Patient Data](./guides/fetching-patient-data.md) — understand the response structure and work with identifiers
- [Working with Claims](./guides/working-with-claims.md) — decode ExplanationOfBenefit responses
